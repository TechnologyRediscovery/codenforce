...
class MockedCursor(mock.MagicMixin):
    def __init__(
        ...
        self.new_citystatezip = (
            "NEWSCITY PA 15090" if new_citystatezip else self.old_citystatezip
        )
...
def propertyexternaldata_events():
    return [
        _EnC.event for _EnC in _propertyexternaldata_events_and_corresponding_cursors()
    ]
...
class TestEventTriggers:
    ...
    @pytest.mark.parametrize(
        "event,mocked_cursor", _propertyexternaldata_events_and_corresponding_cursors()
    )
