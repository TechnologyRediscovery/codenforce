...
//        }
    ...
    /**
     * Old logic but good method sig. This method should get the
     ...
     * @throws com.tcvcog.tcvce.domain.SearchException
     */
    public void insertNewCECase(CECase newCase, Credential cred, CEActionRequest cear) throws IntegrationException, BObStatusException, ViolationException, EventException, SearchException {
    ...
    /**
     * Primary event life cycle control method which is called each time an
     * event is added to a code enf case. The primary business logic related to
     * which events can be attached to a case at any given case phase is
     * implemented in this coordinator method.
     *
     ...
     * @param viol the CodeViolation object associated with this event, can be
     * null
     * @return
     * @throws com.tcvcog.tcvce.domain.BObStatusException
     * @throws com.tcvcog.tcvce.domain.IntegrationException
...
//        }
    ...
    /**
     * Pathway for "Evaluating a Proposal" or in other words, making a workflow
     * choice. The exception list is a beast because so many things happen when
     * such an event occurs. TODO: Move to WorkflowCoordinator
     *
     * @param proposal
     * @param chosen
     * @param ceCase
...
//    --------------------------------------------------------------------------
     ...
     * checking businses rules. ALSO creates a corresponding timeline event to
     * match the stipulated compliance date on the violation that's added.
     *
     * @param cv
     * @param cse
