 ...
 */
public  enum SearchParamsCodeViolationUserFieldsEnum 
        implements IFace_userFieldHolder {
    
        
    CREATOR                     ("Logged in case by",
                                "codeviolation.createdby"),
    
    
    COMPLIANCE                     ("Compliance certified by",
                                "codeviolation.complianceuser"),
    
    
    LAST_UPDATOR                     ("Last updated by",
                                "codeviolation.lastupdated_userid"),
    
    
    NULLIFIED                     ("Nullified by",
                                "codeviolation.mullifiedby");
    
    private final String title;
    private final String dbField;
    
    private SearchParamsCodeViolationUserFieldsEnum(String t, String db){
        title = t;
        dbField = db;
    }
