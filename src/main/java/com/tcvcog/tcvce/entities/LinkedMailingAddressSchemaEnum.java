 ...
 * @author sylvia
 */
public enum LinkedMailingAddressSchemaEnum {
    
    HUMANMAILINGADDRESS ("humanmailingaddress","MailingaddressHuman", ""), 
    ...
    private LinkedMailingAddressSchemaEnum(String ltn, String ts, String pk){
