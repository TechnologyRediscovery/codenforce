 ...
 */
package com.tcvcog.tcvce.rental;

import com.tcvcog.tcvce.occupancy.application.*;
 ...
 *
 */
public class RentalRegistrationBB extends BackingBeanUtils implements Serializable {
    ...
    public String selectProperty() {
        ...
        try {
            ...
            ec.redirect("/tcvce/public/services/rental/rental3AddPropertyUnit.xhtml#currentStep");
        } catch (IOException ex) {
        }

        return "configureUnits";
    }
    ...
    public String selectPropertyUnit(PublicInfoBundlePropertyUnit unit) {
        ...
        try {
            ...
            ec.redirect("/tcvce/public/services/rental/rental4SelectForRegistration.xhtml#currentStep");
        } catch (IOException ex) {
        }
    ...
    public String finalizeUnitList() {
        ...
        return "selectUnitForRegistration";
    ...
    public String storeReason() {
        ...
        try {
            ...
            ec.redirect("/tcvce/public/services/rental/rental2ChooseProperty.xhtml#currentStep");
        } catch (IOException ex) {
        }
    ...
    public String reviewApplication() {
        ...
        try {
            ...
            ec.redirect("/tcvce/public/services/rental/rental6ReviewAndSubmit.xhtml");
        } catch (IOException ex) {
        }
    ...
    public String submitApplication(String redir) {
        ...
        try {
            ...
            getFacesContext().addMessage(null,
                    new FacesMessage(FacesMessage.SEVERITY_INFO,
                            "You have successfully submitted your application: " + ex, ""));
            return "";
        }
    ...
    public void submitUnitChangeList()
        ...
        for (PropertyUnit workingUnit : newUnitList) {
            ...
            if (workingUnit != null && workingUnit.getUnitNumber().equals(selectedUnit.getBundledUnit().getUnitNumber())) {
