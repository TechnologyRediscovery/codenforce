...
public class OccupancyIntegrator extends BackingBeanUtils implements Serializable {
    ...
    public List<OccPeriod> getOccPeriodList(int unitID, UserAuthorized u) throws IntegrationException, EventException, AuthorizationException, CaseLifecycleException, ViolationException {
    ...
    public List<OccPeriod> searchForOccPeriods(SearchParamsOccPeriod params, UserAuthorized u) throws IntegrationException, EventException, AuthorizationException, CaseLifecycleException, ViolationException {
    ...
    public OccPeriod getOccPeriod(int periodid, UserAuthorized u) throws IntegrationException, 
                                                                EventException, 
                                                                AuthorizationException, 
                                                                CaseLifecycleException, 
                                                                ViolationException {
