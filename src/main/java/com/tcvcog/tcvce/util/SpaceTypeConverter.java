 ...
 */
@FacesConverter(value="occSpaceTypeConverter")
public class SpaceTypeConverter extends EntityConverter implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String titleS) {
        ...
        OccSpaceType o = (OccSpaceType) this.getViewMap(fc).get(titleS);
        return o;
    }
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object o) {
        ...
        OccSpaceType ost = (OccSpaceType) o;
        String title = ost.getSpaceTypeTitle();
        if (title != null){
            this.getViewMap(fc).put(title, ost);
            return title;
            
        } else {
            return "error convertering space type";
        }
