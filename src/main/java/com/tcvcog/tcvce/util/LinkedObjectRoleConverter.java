 ...
 */
@FacesConverter(value = "linkedObjectRoleConverter")
public class LinkedObjectRoleConverter extends EntityConverter implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String titleS) {
        ...
        LinkedObjectRole lor = (LinkedObjectRole) this.getViewMap(fc).get(titleS);
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object o) {
        ...
        LinkedObjectRole lor = (LinkedObjectRole) o;
        String title = lor.getTitle();
        if (title != null) {
            this.getViewMap(fc).put(title, o);
            return title;

        } else {
            return "linked object role type converter error";
        }
