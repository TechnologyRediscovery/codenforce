...
public class PublicInfoBundleConverter extends EntityConverter implements Converter{
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String titleS) {
        System.out.println("PublicInfoBundleConverter| title: " +titleS);
        if(titleS.isEmpty()) {
            return null; 
        }
        PublicInfoBundle o = (PublicInfoBundle) this.getViewMap(fc).get(titleS);
        return o;
    }

    @Override
    public String getAsString(FacesContext fc, UIComponent uic, Object o) {
        System.out.println("PublicInfoBundle.getAsString");
        
        if (o == null){
            return "";
        }
        
        PublicInfoBundle pib = (PublicInfoBundle) o;
        String title = pib.toString();  
        if (title != null){
