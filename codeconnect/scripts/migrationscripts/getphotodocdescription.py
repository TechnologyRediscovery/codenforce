...
unmatched_housedir_log = 'unmatched_housedir_error.txt'
unmatched_filetype_log = 'unmatched_filetype_error.txt'
duplicate_housedir_log = 'duplicate_housedir_error.txt'

vacant_streetdir_log = 'vacant_streetdir_error.txt'
impure_streetdir_log = 'impure_streetdir_error.txt'
vacant_housesdir_log = 'vacant_housesdir_error.txt'

unmatched_duplicate_housedir_log = 'unmatched_duplicate_housedir.txt'
duplicate_duplicate_housedir_log = 'duplicate_duplicate_housedir.txt'
