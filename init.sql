...
CREATE OR REPLACE FUNCTION process_patch_audit() RETURNS TRIGGER AS $patchaudit$
    BEGIN
	Return_cd = '0000'
...
CREATE EVENT TRIGGER PATCH_AUDIT ON ddl_command  
...
CREATE TABLE IF NOT EXISTS patch_audit_archive (pa_arc_id SERIAL  varchar(2) PRIMARY KEY,
...
select * into patch_audit_archive from patch_audit;
#WORKDIR /code
